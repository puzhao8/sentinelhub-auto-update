...
def del_sentinel_from_asset():
    ...
    julian_today_th = (today - datetime(2022, 1, 1)).days - 3

    print(date_th, julian_today_th)

    for imgCol_name in ["MODIS_NRT"]: # "Sentinel1", "Sentinel2",
        ...
        for asset_id in asset_list:
            ...
            if 'MOD09GA' in filename: 
                date = filename.split("_")[1][-3:] # VNP09GA_NRT_A2021199_h10v03_001

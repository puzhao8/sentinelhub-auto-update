...
if __name__ == "__main__":
    ...
    # Configuration 
    date = '2022-09-01' # you only need to change this
    year = 2022
    ...
    for date_time in date_range("2022-09-05", "2022-09-05"):
        ...
        # # set property
        # from set_eeImgCol_property import set_property_for_eeImgCol
        # set_property_for_eeImgCol(eeImgColName="MODIS_NRT", julian_day_list=[julian_day], year=year)

        # TODO: delete older images ...

...
def viirs_preprocessing_and_upload(dataPath, FOLDER):
    ...
    for file in fileList:
        ...
        if(ee.ImageCollection("users/omegazhangpzh/MODIS_NRT")
...
if __name__ == "__main__":
    ...
    laads_client.query_filelist_with_date_range_and_area_of_interest(date, products_id=[products_id], collection_id=collection_id, data_path=f'../data/data/{eeImgColName}/{FOLDER}', julian_day=str(date_ndays))
    laads_client.download_files_to_local_based_on_filelist(date, products_id=[products_id], collection_id=collection_id, data_path=f'../data/data/{eeImgColName}/{FOLDER}', julian_day=str(date_ndays))

    fileList = viirs_preprocessing_and_upload(dataPath, FOLDER)
    pprint(fileList)
